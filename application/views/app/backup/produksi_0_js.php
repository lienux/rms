<script type="text/javascript">
    ...
    $('#layout_tabel').removeClass('col-lg-12');
    $('#layout_tabel').addClass('col-lg-6');
    
    list_data();

    function list_data(){
        $.ajax({
            url: base_url + 'produksi/get_biaya',
            type: 'GET',
            dataType: 'JSON',
            contentType: false,
            processData: false,
    ...
    function createTable(data){
        ...
        for(index in data){
            ...
            harga = parseFloat(data[index].harga);
            ...
            "<tr>"+
                ...
                "<td>"+nama+"</td>"+
                "<td class='text-right'>"+parseInt(harga).toLocaleString()+"</td>"+
